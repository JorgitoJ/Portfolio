        ...
        <nav className='container mx-auto px-6 py-4'>
            <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center gap-3 md:gap-6 '>
                    ...
                    <span className="hidden sm:inline text-lg font-semibold hover:text-purple-600 transition-colors">Habilidades</span>
                    </a>
                    ...
                    <span className="hidden sm:inline text-lg font-semibold hover:text-purple-600 transition-colors">Proyectos</span>
                    </a>
                    ...
                    <span className="hidden sm:inline text-lg font-semibold  hover:text-purple-600 transition-colors">Acerca de mi</span>
                    </a>
                    ...
                    <span className="hidden sm:inline text-lg font-semibold hover:text-purple-600 transition-colors">Contacto</span>
                    </a>
                </div>
            </div>
        </nav>
